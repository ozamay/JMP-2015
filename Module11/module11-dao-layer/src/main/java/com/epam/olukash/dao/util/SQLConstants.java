...
public class SQLConstants
{
	...
	public static final String SQL_CREATE_POST = "INSERT INTO APP_POST (POSTID, USERID, POSTTEXT, CREATEDATE) VALUES (?, ?, ?, ?)";
	...
	public static final String SQL_SELECT_POST = "SELECT POSTID, USERID, POSTTEXT, CREATEDATE FROM APP_POST WHERE POSTID = ?";
	...
	public static final String SQL_GET_ALl_POSTS = "SELECT POSTID, USERID, POSTTEXT, CREATEDATE FROM APP_POST";
	...
	public static final String SQL_REMOVE_POST = "DELETE FROM APP_POST WHERE POSTID = ?";
